...
namespace KadenZombie8.BIMOS.Rig.UI
{
    /// <summary>
    ...
    /// </remarks>
    [AddComponentMenu("XR/UI Press Animator", 22)]
    public class UIPressAnimator : MonoBehaviour, IPointerDownHandler, IPointerUpHandler
    {
        [SerializeField]
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        void OnPokeStateDataUpdated(PokeStateData data)
        {
            ...
            if (_isStuck || _isPressed)
            {
                m_TransformTweenableVariable.target = Vector3.zero;
            }
        }
        ...
        void OnValidate()
        {
            ...
            Vector3 position = m_PokeFollowTransform.localPosition;
