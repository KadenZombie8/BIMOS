...
namespace KadenZombie8.BIMOS.AnimationRigging
{
    ...
    /// </summary>
    [BurstCompile]
    public struct LimitedTwoBoneIKConstraintJob : IWeightedAnimationJob
    {
        ...
        public void ProcessAnimation(AnimationStream stream)
        {
            ...
            if (w > 0f)
            {
                LimitedTwoBoneIKConstraintUtils.SolveTwoBoneIK(
            ...
            {
                LimitedTwoBoneIKConstraintUtils.PassThrough(stream, root);
                LimitedTwoBoneIKConstraintUtils.PassThrough(stream, mid);
                LimitedTwoBoneIKConstraintUtils.PassThrough(stream, tip);
            }
        }
    }
    ...
    /// </summary>
    public interface ILimitedTwoBoneIKConstraintData
    {
    ...
    public class LimitedTwoBoneIKConstraintJobBinder<T> : AnimationJobBinder<LimitedTwoBoneIKConstraintJob, T>
        where T : struct, IAnimationJobData, ITwoBoneIKConstraintData
    {
        ...
        public override LimitedTwoBoneIKConstraintJob Create(Animator animator, ref T data, Component component)
        {
            var job = new LimitedTwoBoneIKConstraintJob();
        ...
        public override void Destroy(LimitedTwoBoneIKConstraintJob job)
        {
        }
    }
}
