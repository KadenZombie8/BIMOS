...
namespace KadenZombie8.BIMOS.Ragdoll.Editor
{
	...
	{
		public static void DrawControllers(RagdollWindow boneHelper, Quaternion lastRotation, Transform transform, Vector3 pos)
		{
		...
		/// </summary>
		static void ProcessColliderScale(RagdollWindow boneHelper, Quaternion rotatorRotation, Transform transform, Vector3 pos)
		{
